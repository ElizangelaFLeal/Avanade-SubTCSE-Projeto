...
namespace Avanade_SubTCSE_Projeto.Apli.AutoMapperConfigs.Profiles.Employee
{
    public class EmployeeProfile : Profile
    {
        public EmployeeProfile()
        {
            CreateMap<Dtos.Employee.EmployeeDto, Doma.Aggregates.Employee.Entities.Employee>()
                .ConstructUsing((ctor, res) =>
                {
                    return new Doma.Aggregates.Employee.Entities.Employee(
                        firstName: ctor.PrimeiroNome,
                        surName: ctor.Sobrenome,
                        birthday: ctor.Aniversario,
                        active: ctor.Ativo,
                        salary: ctor.Salario,
                        employeeRole: res.Mapper.Map<Doma.Aggregates.EmployeeRole.Entities.EmployeeRole>(ctor.Cargo));
                })
                .ForAllOtherMembers(i => i.Ignore());

            CreateMap<Doma.Aggregates.Employee.Entities.Employee, Dtos.Employee.EmployeeDto>()
